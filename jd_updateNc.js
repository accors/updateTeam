...
async function writeFile() {
  ...
  await fs.writeFileSync(`./shareCodes/jxnc.txt`, str.substring(0, str.length - 1));
  console.log(`\n${JSON.stringify(str.substring(0, str.length - 1))}\n`);
  console.log(`文件写入成功`);
}
function getJxNc(){
              ...
              if ((data)) {
                ...
                if (data["ret"] === 0) {
                  if (data.active) {
                    ...
                    str += JSON.stringify(shareCodeJson) + '@';
                  } else {
