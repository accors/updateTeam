...
const inviteCodes = ['1330186694770339842'];
!(async () => {
  if (!cookiesArr[0]) {
...
function showMsg() {
  return new Promise(async resolve => {
    ...
    try {
      await $.http.get({url: `https://purge.jsdelivr.net/gh/zero205/updateTeam@master/jd_updateSmallHomeInviteCode.json`}).then((resp) => {
